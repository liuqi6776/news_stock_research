"""
doubao_result strategy backtest code
Model: doubao_t1t2_model.joblib (5 features)
Strategy: S1 - prob > 0.8, Top3, fallback Top1
...
def run():
    ...
    print(f"doubao_result (T+1 buy T+2 close sell, No TP):")
