"""
Step 1: Analyze news from HTML files -> Generate news_major1 JSON
Uses ZhipuAI to analyze market/sector/stock impact
"""
import os
import re
import json
...
OUTPUT_DIR = os.path.join(THIS_DIR, "news_major1")
