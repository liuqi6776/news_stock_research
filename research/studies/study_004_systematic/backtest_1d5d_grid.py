...
def run():
    t0 = time.time()
    print("Loading OHLC...", flush=True)
    ohlc_lookup = load_ohlc()
    ...
    for strat in STRATEGIES:
        ...
        for ci, combo in enumerate(strat['combos']):
            ...
            bt0 = time.time()
            daily_pnl, trading_dates = backtest(pred, ohlc_lookup, th, mp, sl, tp, hold_days)
