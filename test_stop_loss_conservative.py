...
def main():
    ...
    print("\n" + "="*80)
    print("测试止损策略（保守版本：如果同一天既触及止损又触及止盈，按止损处理）")
    print("="*80)
    ...
    summary_csv = os.path.join(OUTPUT_DIR, 'stop_loss_comparison_conservative.csv')
    ...
    plt.title('止损策略对比（保守版：同时触及按止损处理）', fontsize=16, fontweight='bold')
    ...
    comparison_png = os.path.join(OUTPUT_DIR, 'stop_loss_comparison_conservative.png')
